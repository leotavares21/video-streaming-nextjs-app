  ...
  if (type === 'small') {
    return (
      <>
        {isOpen && (
          <div
            className="bg-gray-50 rounded-xl absolute bottom-0"
            ref={containerRef}
          >
    ...
    <>
      {isOpen && (
        <div className="fixed left-[0vw] top-[0vh] w-[100vw] h-[100vh] bg-[rgba(0,0,0,0.6)] backdrop-blur-md z-50">
          <div
            className="bg-gray-50 rounded-xl absolute w-[40rem] max-w-[95vw] top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2"
            ref={containerRef}
          >
            <ModalHeader onClose={onClose} title={title} />
